...
function buildToDo(todo, index) {
  // Tu código acá:
  var toDoShell = document.createElement('div') // crea un <div></div>
  toDoShell.className = 'toDoShell' // agrega una clase <div class="toDoShell"></div>
  var toDoText = document.createElement('span') // crea un <span></span>
  toDoText.innerHTML = todo.description // agrega al <span>todo.description</span>
...
function buildToDos(toDos) {
  // Tu código acá:
  var array = toDos.map(function (el, index) {
...
function addToDo() {
  ...
  if (value !== '') {
    ...
    alert("Escribe algo dentro del input")
  }
}
